...
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('1', 'eeee', '', '\\cite[pag. 110]{hvalkof:cjo:15} \\cite[pag. 84]{anderson:cuentos:85}', 'sound.of.fear/anguish', 'Ideo', 'sonido.de.miedo/angustia', NULL, NULL, NULL, '+whistle.lang.+mono.syl.', NULL, NULL);
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('2', 'eee', '', '\\cite[pag. 84]{anderson:cuentos:85}', 'sound.of.fear/anguish', 'Ideo', 'sonido.de.miedo/angustia', '', '', '', '+whistle.lang.+mono.syl.', NULL, NULL);
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('3', 'shikerek', '', '\\cite[pag. 96]{anderson:cuentos:85}', 'animal.cry.made.by.a.bear/maini', 'Ideo', NULL, NULL, NULL, NULL, '+tri.syl.', NULL, NULL);
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('4', 'toom', '', '\\cite[pag. 96]{anderson:cuentos:85}', 'sound.of.a.rock.being.moved', 'Ideo', 'sonido.de.una.roca.siendo.movida', NULL, NULL, NULL, '+mono.syl.', NULL, NULL);
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('6', 'aaa', '', '\\cite[pag. 105]{anderson:cuentos:85}', 'parrot/savaro.squawking.sound', 'Ideo', 'sonido.del.garritar.del.papagayo/savaro', NULL, NULL, NULL, '+mono.syl.+s.redup.word', NULL, NULL);
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('7', 'chempok', '', '\\cite[pag. 112]{anderson:cuentos:85}', 'action.of.a.shrimp.jumping/mitaantsi', 'Ideo', 'acción.de.el.saltar/mitaantsi.de.un.camarón', NULL, NULL, NULL, '+di.syl.+s.redup.word', NULL, NULL);
INSERT INTO `ADBL`.`Spelling` (`Id_Spelling`, `Word`, `Spelling_System`, `Source`, `Definition_EN`, `Gloss_EN`, `Definition_ES`, `Gloss_ES`, `Definition_PT`, `Gloss_PT`, `Morphological_Values`, `Example`, `Frequency`) VALUES ('8', 'satak', '', '\\cite[pag. 114]{anderson:cuentos:85}', 'action.of.chewing.ivenki', 'Ideo', 'acción.de.masticar.ivenki', NULL, NULL, NULL, NULL, NULL, NULL);
